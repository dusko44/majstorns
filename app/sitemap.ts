...
const BASE_URL = "https://majstorns.vercel.app";
...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/kategorije`, changeFrequency: "weekly", priority: 0.9 },
    { url: `${BASE_URL}/kontakt`, changeFrequency: "monthly", priority: 0.4 },
    { url: `${BASE_URL}/o-nama`, changeFrequency: "monthly", priority: 0.3 },
  ];
